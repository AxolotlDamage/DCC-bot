...
# --- (Removed legacy attack implementation block) ---
    ...
    if first:
        ...
        if os.path.exists(candidate_file):
            ...
            # use the current initiative character as attacker and treat first arg as weapon.
            if initiative.INITIATIVE_ORDER and initiative.CURRENT_TURN_INDEX is not None:
                ...
                # No initiative context: treat first arg as attacker name
                attacker_name = first
                if len(args) > 1 and not args[1].startswith('-'):
                    attack_name = args[1]
                    i = 2
